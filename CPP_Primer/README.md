...
> The project was copied from https://github.com/Mooophy/Cpp-Primer tomake it easier to add notes based on my personal habits, thanks to the original author!
